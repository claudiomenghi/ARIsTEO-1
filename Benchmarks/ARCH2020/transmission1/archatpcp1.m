...
function []=archatpc2(modelsstructure,currentOrder)
    ...
    for i=1:size(properties,2)
        ...
        save(strcat('AT_pconst','_','Autotrans_shift_pconst','_',propertiesString{i},'_',opt.abstraction_algorithm,currentOrder),'results','history');
