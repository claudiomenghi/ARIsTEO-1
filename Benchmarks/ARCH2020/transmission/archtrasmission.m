...
function []=archtrasmission(modelsstructure,currentOrder)
    ...
    properties={at1,at2,at51,at52,at53,at54,at6a,at6b,at6c};

    propertiesString={'at1','at2','at51','at52','at53','at54','at6a','at6b','at6c'};
    ...
    for i=1:size(properties,2)
        ...
        [results,history] = aristeo(model,init_cond,input_range,cp_array,phi,preds,tf,opt);
