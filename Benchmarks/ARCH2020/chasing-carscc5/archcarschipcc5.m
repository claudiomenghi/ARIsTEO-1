...
function []=archcarschipcc5(modelsstructure,currentOrder)
    ...
    for i=1:size(properties,2)
        ...
        save(strcat('ARIsTEO_Arch19Bench_pchip','_','CC','_',propertiesString{i},'_',opt.abstraction_algorithm,currentOrder),'results','history');
