...
function []=archatpc6a(modelsstructure,currentOrder)
...
propertiesString={'at6a'};
    ...
    for i=1:size(properties,2)
        ...
        save(strcat('AT_pconst','_','Autotrans_shift','_',propertiesString{i},'_',opt.abstraction_algorithm,currentOrder),'results','history');
