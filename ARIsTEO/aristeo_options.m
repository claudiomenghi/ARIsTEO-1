...
% See also: staliro, staliro_blackbox
    ...
    properties
        ...
        dispinfoaristeo=1;
        nbr_Runs=100;
        % Sets the initial time used for the system identification (SI). This is useful to crop parts of the simulation to be used for the SI
        init_identification_time=0;
    end
   methods

       function obj = set.nbr_Runs(obj,nbr_Runs)
            obj.nbr_Runs=nbr_Runs;
       end

       function obj = set.init_identification_time(obj,init_identification_time)
            obj.init_identification_time=init_identification_time;
       end
